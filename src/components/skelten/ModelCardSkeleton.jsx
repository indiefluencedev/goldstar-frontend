...
const ModelCardSkeleton = () => {
  return (
    ...
    <div className="grid-item p-4 border border-gray-200 rounded shadow animate-pulse">
      <div className="flex items-center justify-center h-[300px] mb-4 bg-gray-300 rounded">
